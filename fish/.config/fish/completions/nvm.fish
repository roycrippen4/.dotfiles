...
complete --command nvm --exclusive --condition __fish_use_subcommand --arguments set-default --description "Set the specified Node version as the system default"
...
complete --command nvm --exclusive --condition "__fish_seen_subcommand_from set-default" --arguments "(_nvm_list | string split ' ')"

...
---@overload fun(opts?: ScrollbarOptions): Scrollbar
...
function Scrollbar:update()
  ...
  local buf_height = utils.win_buf_height(self.winnr)
  ...
  utils.win_apply_config(self.bar.winnr, {
    height = dim.height,
    width = 1,
  ...
  utils.win_apply_config(self.thumb.winnr, {
    width = 1,
    height = thumb_height,

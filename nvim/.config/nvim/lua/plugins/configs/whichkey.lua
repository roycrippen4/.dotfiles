...
whichkey.register({
  ...
  -- ['<Leader>o'] = { name = 'Step over', _ = 'which_key_ignore' },
  -- ['<Leader>i'] = { name = 'Step into', _ = 'which_key_ignore' },
  -- ['<Leader>O'] = { name = 'Step out', _ = 'which_key_ignore' },
  -- ['<leader>b'] = { name = 'Toggle breakpoint', _ = 'which_key_ignore' },
